...
--
-- Machine: localhost
-- Genereertijd: 21 apr 2015 om 17:24
-- Serverversie: 5.6.13
-- PHP-versie: 5.4.17
...
--
ALTER TABLE `members`
  ADD CONSTRAINT `fk_memebers_family` FOREIGN KEY (`family_id`) REFERENCES `family` (`family_id`);
...
ALTER TABLE `shopping_list`
  ADD CONSTRAINT `fk_shopping_list_family2` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`),
  ADD CONSTRAINT `fk_shopping_list_family` FOREIGN KEY (`family_id`) REFERENCES `family` (`family_id`);
