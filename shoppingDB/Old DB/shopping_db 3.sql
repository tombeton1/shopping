...
INSERT INTO `recipe` (`recipe_id`, `recipe_category_id`, `recipe_name`, `recipe_amount`, `recipe_amount_unit`, `recipe_text`) VALUES
(3, 1, 'aarbeien', 5, NULL, 'mqsdlmqsdklmdsql'),
(4, 1, 'asperges', 2, 'kg', 'lksqjqlskfjqslkjkldjqlkdjq');
